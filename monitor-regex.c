...
static inline void dump_args(vms_stream *stream, vms_event_regex *ev,
...
int main(int argc, char *argv[]) {
    ...
    vms_stream *fstream = create_stream(argc, argv, 1, "regex-stream", NULL);
    ...
    while (shamon_is_ready(shmn)) {
        while ((ev = shamon_get_next_ev(shmn, &stream))) {
            ...
            */
            ...
            vms_event_regex *reev = (vms_event_regex *)ev;
            printf("{");
